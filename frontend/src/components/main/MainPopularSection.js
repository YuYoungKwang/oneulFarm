...
function getRecipeItem(recipe) {
  ...
  return {
    product: {
      productName: firstIngredient || "재료 정보 준비 중",
    },
    linkedRecipes: recipe ? [recipe] : [],
    description: recipe?.summary || "추천 메뉴 정보를 준비 중입니다.",
  };
}
      ...
      <div className="section-head">
        <div>
          ...
          <div className="section-sub">
            {
              "\uB9CE\uC774 \uCC3E\uB294 \uBA54\uB274\uB97C \uBCF4\uACE0 \uD544\uC694\uD55C \uC7AC\uB8CC\uB294 \uB808\uC2DC\uD53C \uC0C1\uC138 \uD398\uC774\uC9C0\uC5D0\uC11C \uD655\uC778\uD560 \uC218 \uC788\uC5B4\uC694."
            }
          </div>
        </div>
        ...
        <div className="main-link-card-grid">
          {items.map((recipe) => (
            <MainIngredientLinkCard
              ...
              item={getRecipeItem(recipe)}
              onImageError={handleImageError}
              onOpenRecipe={openRecipe}
              title={
                recipe.recipeName || "\uC9C0\uAE08 \uC778\uAE30 \uC788\uB294 \uBA54\uB274"
              }
              tone="recipe"
            />
          ))}
